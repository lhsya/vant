...
importers:
  ...
  packages/vant:
    ...
    devDependencies:
      ...
      '@vant/area-data':
        specifier: workspace:*
        version: link:../vant-area-data
      '@vant/cli':
        specifier: workspace:*
        version: link:../vant-cli
      '@vant/eslint-config':
        specifier: workspace:*
...
packages:
  ...
  /vitest-canvas-mock@0.3.2(vitest@0.34.2):
    resolution: {integrity: sha512-lds7MKxvFFPDCGLXsQI2ym1fxvC93DaS0Bb6sdjvylFyL6NYrAAcPb6xZGF2sMOt5fSLHddqAQaujqpbc3p0Zg==}
    peerDependencies:
      vitest: '*'
    dependencies:
      jest-canvas-mock: 2.4.0
