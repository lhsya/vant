...
function getSiteDevBaseConfig() {
    ...
    const headHtml = lodash_1.get(vantConfig, 'site.headHtml');
    ...
    return webpack_merge_1.merge(webpack_base_1.baseConfig, {
        ...
        plugins: [
            ...
            new html_webpack_plugin_1.default(Object.assign({ title, logo: siteConfig.logo, description: siteConfig.description, usingSearch: !!siteConfig.searchConfig, chunks: ['chunks', 'site-desktop'], template: path_1.join(__dirname, '../../site/desktop/index.html'), filename: 'index.html', headHtml,
                baiduAnalytics }, htmlPluginOptions)),
            new html_webpack_plugin_1.default(Object.assign({ title, logo: siteConfig.logo, description: siteConfig.description, chunks: ['chunks', 'site-mobile'], template: path_1.join(__dirname, '../../site/mobile/index.html'), filename: 'mobile.html', headHtml,
                baiduAnalytics }, htmlPluginOptions)),
        ],
    });
}
